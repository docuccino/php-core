 ...
 * is method + URI, while the cache signature additionally folds the resolved action target,
 * normalised middleware and any scalar cache inputs so a change to any of them busts the fragment
 * cache even when the human signature is unchanged.
 */
