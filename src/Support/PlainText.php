 ...
 * steers a terminal rather than showing in it becomes a visible escape — an ASCII control as `\xNN`, a C1
 * control or a bidi formatting character as `\u{XXXX}`. Everything else, non-ASCII included, is left
 * exactly as written, because a name or a description may legitimately carry it.
 *
...
{
    /**
     * ASCII controls and DEL, the C1 controls (U+0080-U+009F), and the Unicode bidirectional formatting
     * characters (U+061C, U+200E-U+200F, U+202A-U+202E, U+2066-U+2069) — the ones that reorder a line
     * without showing in it.
     */
    private const string UNSAFE = '/[\x00-\x1F\x7F]|\xC2[\x80-\x9F]|\xD8\x9C|\xE2\x80[\x8E\x8F\xAA-\xAE]|\xE2\x81[\xA6-\xA9]/';
